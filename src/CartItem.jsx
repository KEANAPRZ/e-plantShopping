...
const CartItem = ({ onContinueShopping }) => {
  ...
  const [isCheckedOut, setIsCheckedOut] = useState(false); // State to manage checkout status
  ...
  const handleContinueShopping = () => {
    onContinueShopping(); // Close cart and continue shopping
  };
      ...
      <div className="checkout-btn">
        {!isCheckedOut ? (
          ...
          <div className="thank-you-message">
            <h3>Thank You For Checking Out</h3>
          </div>
        )}
      </div>
    </div>
